...
//
// The example functions in the library make heavy use of the external package
// github.com/yanjunhui/meeus/sexa for formatted output.  That package has
// features for recognizing the accuracy limitations of a float64 and
// and indicating accuracy limits in formatted output.  See sexagesimal package
